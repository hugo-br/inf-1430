<template>
  <div id="tasks-menu">
    <div class="sticky top-0">{{ $t("titles.main") }}</div>
    <nav id="task-menu-nav" class="inline-flex flex-col space-y-2">
      <a
